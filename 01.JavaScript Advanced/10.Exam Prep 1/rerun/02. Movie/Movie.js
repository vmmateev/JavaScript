class Movie {
    ...
    newScreening(date, hall, description) {
        if (this.screenings.some(s => s.date == date && s.hall == hall)) { // some ако 1 е true връща true / като any е може и с find но проверяваме дали не е == undefined понеже ако не намери нищо връща undefined
